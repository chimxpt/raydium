...
public class CompileResult {
    ...
    // === RT PATCH (M8.142): эмиссивные блоки секции, собранные при сборке (8 float на источник,
    //     формат RtLights.writeLight). Заливаются в RtLights по ключу секции в doSectionUpdate. ===
    public float[] lights;
