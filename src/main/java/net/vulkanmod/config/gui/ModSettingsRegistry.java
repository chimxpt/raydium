...
public class ModSettingsRegistry {
    ...
    ModSettingsRegistry() {
        // === RT PATCH (M8.128, ребрендинг Raydium): имя + знак + акцент спектра ===
        ModSettingsEntry vulkanModSettings = new ModSettingsEntry(Component.literal("Raydium")
                                                                          .withStyle(s -> s.withColor(0x40C4FF)),
                                                                  () -> Identifier.fromNamespaceAndPath("vulkanmod", "raydium_logo_transparent.png"),
